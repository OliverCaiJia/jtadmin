...
class AdminInitSeeder extends Seeder
{
    ...
    public function run()
    {
        \DB::select(
            <<<SQL
                INSERT INTO `jt_admin_permissions` (`id`, `name`, `label`, `description`, `cid`, `icon`, `created_at`, `updated_at`)
VALUES
	...
	(14, 'admin.department.index', '部门管理', '', 1, '', '2016-05-23 10:40:36', '2016-05-23 10:40:36'),
	(15, 'admin.department.create', '部门添加', '', 1, '', '2016-05-23 10:40:36', '2016-05-23 10:40:36'),
	(16, 'admin.department.edit', '部门编辑', '', 1, '', '2016-05-23 10:40:36', '2016-05-23 10:40:36'),
	(17, 'admin.department.destroy', '部门删除', '', 1, '', '2016-05-23 10:40:36', '2016-05-23 10:40:36')
SQL
        );
        AdminUser::create([
           'name' => 'root',

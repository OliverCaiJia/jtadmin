<div class="bjui-pageContent">
    <form id="j_pwschange_form" action="/admin/view/changepwd" data-toggle="validate" method="post">
        ...
        <div class="form-group">
            ...
            <input type="password" data-rule="required" name="old_pass" id="j_pwschange_oldpassword" value="" placeholder="旧密码" size="20">
        </div>

...
<head>
    ...
    {{--loding--}}
    <link href="/plugins/AdminLTE/css/load/load.css" rel="stylesheet">
...
<div class="wrapper">
    ...
    <!-- Main Header -->
    @include('admin_rbac.layouts.mainHeader')
            <!-- Left side column. contains the logo and sidebar -->
    @include('admin_rbac.layouts.mainSidebar')
...
<script src="/plugins/AdminLTE/js/common.js"></script>
...
@yield('js')
        <!-- Main Footer -->
@include('admin_rbac.layouts.mainFooter')
</body>
</html>

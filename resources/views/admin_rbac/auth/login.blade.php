    ...
    <div class="login-box-body">
        ...
        <form action="{{ url('/admin/login') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="名称"  name="username" value="{{ old('username') }}">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" style="height: auto;">登录</button>
                </div>
                <!-- /.col -->
            </div>
        </form>

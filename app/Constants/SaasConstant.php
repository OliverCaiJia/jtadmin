...
class SaasConstant extends AppConstant
{
    ...
    // 合作方审查条件种类
    const SAAS_FILTER_KIND_NECESSIRY = 1;
    const SAAS_FILTER_KIND_UNNECESSIRY = 2;

    const SAAS_FILTER_KIND_MAP = [
        self::SAAS_FILTER_KIND_NECESSIRY => '必要',
        self::SAAS_FILTER_KIND_UNNECESSIRY => '非必要'
    ];

...
+function ($) {
    ...
    var BJUI = {
        ...
        ajaxTimeout: 30000,
        statusCode: {ok:200, error:500, timeout:301},
...
+function ($) {
    ...
    Bjuiajax.prototype.ajaxform = function(option) {
        ...
        var errorFn = function(xhr, ajaxOptions, thrownError) {
            that.$target.trigger('bjui.ajaxError')
            that.ajaxerror(xhr, ajaxOptions, thrownError)
        }
        var _submitFn = function() {
            var op = {loadingmask:that.options.loadingmask, type:that.options.type, url:that.options.url, callback:successFn, error:errorFn}
